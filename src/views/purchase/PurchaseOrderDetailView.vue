    ...
    <section class="block">
      ...
      <ul v-if="isMobile" class="item-cards">
        <li v-for="(it, i) in items" :key="i" class="item-card">
          ...
          <div v-if="canSeePurchasePrice" class="ic-line">单价 ¥{{ money(it.price) }}</div>
          <div v-if="canSeePurchasePrice" class="ic-line">金额 ¥{{ money(it.subtotal) }}</div>
        </li>
      ...
      <table v-else class="item-table">
        ...
        <tbody>
          <tr v-for="(it, i) in items" :key="i">
            ...
            <td v-if="canSeePurchasePrice" class="num">¥{{ money(it.price) }}</td>
            <td v-if="canSeePurchasePrice" class="num">¥{{ money(it.subtotal) }}</td>
          </tr>
