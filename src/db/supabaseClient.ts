 ...
 * URL：https://ksprzfqqbfcuuavxoklq.supabase.co
 *
 * 注意：URL 里是 ksprzfqq（双 q），不是单 q。
 * anon/publishable key 设计为前端公开使用，第一版暂未开 RLS，
 * 应用层自有登录保护；后续接入 Supabase Auth 后改 RLS 行级权限。
 */
const SUPABASE_URL = 'https://ksprzfqqbfcuuavxoklq.supabase.co'
const SUPABASE_ANON_KEY = 'sb_publishable_mkd7NgQH3BKEjLfbcFo1mg_LlpTVQEb'
